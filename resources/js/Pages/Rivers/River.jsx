        ...
        <div className="p-6 flex space-x-2">
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    <div>
                        <span className="text-gray-800">{river.user.name}</span>
                        <small className="ml-2 text-sm text-gray-600">
                            {new Date(river.created_at).toLocaleString()}
                        </small>
                        {river.created_at !== river.updated_at && (
                    ...
                    {river.user.id === auth.user.id && (
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                ...
                                <Dropdown.Link
                                    as="button"
                                    href={route("rivers.destroy", river.id)}
                                    method="delete"
                                >
                                    Delete
                                </Dropdown.Link>
